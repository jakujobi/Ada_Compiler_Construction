...
* **[X] Update `SymTable.py` (CRITICAL):**
  ...
  * [X] **Implement/Verify:** Add (if missing) `size_of_locals: int` field to procedure entries.
  * [X] **Implement/Verify:** Add (if missing) `size_of_params: int` field to procedure entries.
