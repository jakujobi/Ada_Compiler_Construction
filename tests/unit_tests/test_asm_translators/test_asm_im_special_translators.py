...
from jakadac.modules.asm_gen.instruction_translators.asm_im_special_translators import SpecialTranslators
...
from jakadac.modules.asm_gen.instruction_translators.asm_im_arithmetic_translators import ArithmeticTranslators # For _translate_rem
